/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc` (hash: 93628e1dab11c37a91743d96aa275555)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		CORS_ORIGIN: "https://lingo-now.pages.dev";
		GROQ_API_KEY: string;
		CARTESIA_API_KEY: string;
		TRANSLATE_ACCESS_PASSWORD: string;
	}
	interface DevelopmentEnv {
		CORS_ORIGIN: "http://localhost,capacitor://localhost,http://localhost:5173";
		GROQ_API_KEY: string;
		CARTESIA_API_KEY: string;
		TRANSLATE_ACCESS_PASSWORD: string;
	}
	interface Env {
		CORS_ORIGIN?: "https://lingo-now.pages.dev" | "http://localhost,capacitor://localhost,http://localhost:5173";
		GROQ_API_KEY?: string;
		CARTESIA_API_KEY?: string;
		TRANSLATE_ACCESS_PASSWORD?: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ORIGIN" | "GROQ_API_KEY" | "CARTESIA_API_KEY" | "TRANSLATE_ACCESS_PASSWORD">> {}
}
